    ...
    return (
      <div className="mx-auto max-w-[520px] px-4 py-8">
        <div className="rounded-3xl bg-white p-6 text-center text-slate-900">
          ...
          <Link href="/message" className="mt-5 inline-block rounded-full bg-rose-500 px-5 py-3 font-bold text-white">আবার তৈরি করুন</Link>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-[calc(100svh-9rem)] px-4 py-8">
      <section className="mx-auto max-w-[520px]">
        <h1 className="text-3xl font-black text-white">তৈরি করা বার্তা</h1>
        ...
        <div className="mt-6 grid gap-4">
          {result.messages.map((message, index) => (
            <article key={message} className="rounded-3xl bg-white p-5 text-slate-900">
              <h2 className="font-bold">বার্তা {index + 1}</h2>
        ...
        <div className="mt-4 flex flex-col gap-3">
          <Link href="/message" className="min-h-14 rounded-full bg-rose-500 px-5 py-4 text-center font-bold text-white">আবার তৈরি করুন</Link>
